...
public class TicTagToeGame {
	...
	// Location of square in array determines which square it represents in the
	// display
	Square[] squares;
	...
	public void setMove(int locationArg, int playerArg) {
		if (winner == 0)
			squares[locationArg].setMove(playerArg);
		checkForWinner();
	}
	...
	public class Square {
		...
		// setMove takes a 0, 1, or 2. 0 resets the square, 1 places an X, 2
		// places an O
